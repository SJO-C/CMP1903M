...
namespace CMP1903M_Assessment_1_Base_Code
{
    public class Input
    {
        ...
        public string manualTextInput()
        {
            ...
            string text = Console.ReadLine()?? string.Empty;//Reads User Input up to 1st Newline Character.
            return text;
        }
        ...
        {
            {
                ...
                try
                {
                    var text = File.ReadAllText(fileName); //Reads Text of File from Path provided.
